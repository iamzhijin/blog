...
//        strategy.setSuperEntityColumns("id"); //
        strategy.setControllerMappingHyphenStyle(true); // 是否开启驼峰转换
//        strategy.setTablePrefix(pc.getModuleName() + "_"); // blog_user表生成对应实体 名 User
